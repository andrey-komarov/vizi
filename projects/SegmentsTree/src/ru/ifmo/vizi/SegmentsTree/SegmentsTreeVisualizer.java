...
import ru.ifmo.vizi.SegmentsTree.widgets.*;
...
public class SegmentsTreeVisualizer extends Base implements AdjustmentListener, AutomataListener {
	/**
     * Segments tree automata instance.
	 */
	private final SegmentsTree auto;

	/**
	 * Segments tree automata data
	 */
    private final SegmentsTree.Data data;
    ...
    /**
     * Creates a new SegmentsTree visualizer.
     *
     * @param parameters visualizer parameters.
     */
    public SegmentsTreeVisualizer(VisualizerParameters parameters) {
        super(parameters);
