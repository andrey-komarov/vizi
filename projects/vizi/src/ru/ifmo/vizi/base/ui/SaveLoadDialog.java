...
public abstract class SaveLoadDialog extends ModalDialog {
     ...
     */
    public SaveLoadDialog(final Configuration config, final String prefix, final Frame owner) {
        ...
        Panel buttonAndCommentPane = new Panel(new BorderLayout());
     ...
     * @param owner the owner of applet
     */
    public SaveLoadDialog(Configuration config, Frame owner) {
