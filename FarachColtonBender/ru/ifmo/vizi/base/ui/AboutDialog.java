...
public class AboutDialog extends ModalDialog {
     ...
     */
    public AboutDialog(Configuration config, Frame owner) {
        ...
        Label lines[] = new Label[tokenizer.countTokens()];
        for (int i = 0; i < lines.length; i++) {
            lines[i] = new Label(tokenizer.nextToken());
        }
        Label lAlgorithm = new Label(config.getParameter("about-algorithm-caption") + " ", Label.RIGHT);

        Label labelAuthor = new Label(config.getParameter("about-author") + " (" + config.getParameter("about-author-email") + ")");
        Label lAuthor = new Label(config.getParameter("about-author-caption") + " ", Label.RIGHT);
        Label labelSupervisor = new Label(config.getParameter("about-supervisor") + " (" + config.getParameter("about-supervisor-email") + ")");
        Label lSupervisor = new Label(config.getParameter("about-supervisor-caption") + " ", Label.RIGHT);
        Label labelTechnology = new Label(config.getParameter("about-technology") + " (" + config.getParameter("about-technology-email") + ")");
        Label lTechnology = new Label(config.getParameter("about-technology-caption") + " ", Label.RIGHT);
        Label labelAddition = new Label(config.getParameter("about-copyright"), Label.CENTER);
